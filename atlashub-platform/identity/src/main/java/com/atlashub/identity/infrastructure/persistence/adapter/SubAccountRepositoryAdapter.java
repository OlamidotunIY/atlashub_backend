...
import com.atlashub.identity.infrastructure.persistence.entity.SubAccountJpaEntity;
import com.atlashub.identity.infrastructure.persistence.mapper.SubAccountMapper;
import com.atlashub.identity.infrastructure.persistence.repository.SpringDataSubAccountRepository;
...
public class SubAccountRepositoryAdapter implements SubAccountRepository {
    ...
    public SubAccountRepositoryAdapter(SpringDataSubAccountRepository jpaRepository, com.atlashub.shared.infrastructure.DomainSequenceGenerator sequenceGenerator, SubAccountMapper mapper) {
