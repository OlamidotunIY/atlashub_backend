...
import com.atlashub.identity.adapter.out.persistence.mapper.MerchantMapper;
...
public class MerchantRepositoryAdapter implements MerchantRepository {
    ...
    public MerchantRepositoryAdapter(SpringDataMerchantRepository jpaRepository, com.atlashub.shared.adapter.out.external.DomainSequenceGenerator sequenceGenerator, MerchantMapper mapper) {
