...
import com.atlashub.identity.infrastructure.persistence.mapper.ApiKeyMapper;
import com.atlashub.identity.infrastructure.persistence.repository.SpringDataApiKeyRepository;
...
public class ApiKeyRepositoryAdapter implements ApiKeyRepository {
    ...
    public ApiKeyRepositoryAdapter(SpringDataApiKeyRepository jpaRepository, com.atlashub.shared.infrastructure.DomainSequenceGenerator sequenceGenerator, ApiKeyMapper mapper) {
