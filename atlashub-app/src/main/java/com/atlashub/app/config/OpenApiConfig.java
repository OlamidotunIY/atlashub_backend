...
public class OpenApiConfig {
    ...
    public OpenAPI atlasPayOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("AtlasHub API")
                        .description("AtlasHub Core Banking and Payments API")
                        .version("v1.0.0")
                        .contact(new Contact()
                                .name("AtlasHub Engineering")
                                .email("engineering@atlashub.com"))
                        .license(new License().name("Proprietary").url("https://atlashub.com/license")))
