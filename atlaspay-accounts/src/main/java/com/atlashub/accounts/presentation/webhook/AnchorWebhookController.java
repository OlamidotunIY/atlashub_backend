package com.atlashub.accounts.presentation.webhook;

import com.atlashub.accounts.application.command.ActivateVirtualAccountCommand;
import com.atlashub.accounts.application.usecase.ActivateVirtualAccountUseCase;
import com.atlashub.accounts.presentation.webhook.request.AnchorWebhookPayloadDto;
